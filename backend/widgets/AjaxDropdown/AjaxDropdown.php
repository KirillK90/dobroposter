...
namespace backend\widgets\AjaxDropdown;

use backend\widgets\AjaxDropdown\assets\AjaxDropdownAsset;
use Yii;
use yii\base\Widget;
...
class AjaxDropdown extends Widget
{
    ...
    /**
     * @var string Name of the translate category, default 'yii'.
     * @see Yii::t()
     */
    public $translateCategory = 'yii';
